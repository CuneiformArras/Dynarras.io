...
Class.shinyBetaHexagon = makeRare("betaHexagon", 0);
Class.legendaryBetaHexagon = makeRare("betaHexagon", 1);
Class.shadowBetaHexagon = makeRare("betaHexagon", 2);
Class.rainbowBetaHexagon = makeRare("betaHexagon", 3);
Class.transBetaHexagon = makeRare("betaHexagon", 4);
...
Class.shinyAlphaHexagon = makeRare("alphaHexagon", 0);
Class.legendaryAlphaHexagon = makeRare("alphaHexagon", 1);
Class.shadowAlphaHexagon = makeRare("alphaHexagon", 2);
Class.rainbowAlphaHexagon = makeRare("alphaHexagon", 3);
Class.transAlphaHexagon = makeRare("alphaHexagon", 4);
