...
Class.lancerTurret = makeTurret({
    GUNS: [
        {
            POSITION: [46, 16, 0.015, 0, 0, 0, 0],
            PROPERTIES: {
...
}, {canRepel: true, limitFov: true, fov: 16})
Class.pikerTurret = makeTurret({
    GUNS: [
        {
            POSITION: [50, 18, 0.015, 0, 0, 0, 0],
            PROPERTIES: {
...
Class.autoGunnerGun = makeTurret({
    GUNS: [
        {
...
Class.refrainerTurret = makeTurret({
    GUNS: [
        {
