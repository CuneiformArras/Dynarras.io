module.exports = {
    ...
    host: "http://cuneiformarras.github.io/Dynarras.io/",
    ...
    FOOD_TYPES: [
        [2000, [
            [1024, 'egg'], [256, 'square'], [64, 'triangle'], [16, 'pentagon'], [8, 'hexagon'], [4, 'betaPentagon'], [2, 'betaHexagon'], [1, 'alphaPentagon'], [0.25, 'alphaHexagon']
        ]],
        [1, [
            [3125, 'gem'], [625, 'shinySquare'], [125, 'shinyTriangle'], [25, 'shinyPentagon'], [16, 'shinyHexagon'], [5, 'shinyBetaPentagon'], [3, 'shinyBetaHexagon'], [1, 'shinyAlphaPentagon'], [0.25, 'shinyAlphaHexagon']
        ]],
        [0.1, [
            [6836, 'jewel'], [1296, 'legendarySquare'], [216, 'legendaryTriangle'], [36, 'legendaryPentagon'], [16, 'legendaryHexagon'], [6, 'legendaryBetaPentagon'], [1, 'legendaryAlphaPentagon']
        ]],
        [0.005, [
    ...
    FOOD_TYPES_NEST: [
        [1, [
            [16, 'pentagon'], [8, 'hexagon'], [ 4, 'betaPentagon'], [2, 'betaHexagon'], [ 1, 'alphaPentagon'], [0.25, 'alphaHexagon']
        ]]
    ],
    ...
    ENEMY_TYPES_NEST: [
        [19, [
            [24, 'crasher'], [16, 'squareCrasher'], [8, 'pentaCrasher']
        ]],
        [1, [
            [14, 'sentryGun'], [12, 'sentrySwarm'], [10, 'sentryTrap'], [7, 'sentryBomb']
        ]]
    ],
